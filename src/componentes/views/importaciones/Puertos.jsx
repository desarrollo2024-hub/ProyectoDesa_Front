...
const pantallaComponente = ["PUERTO", "PUERTOS", "Puerto"];
      ...
      case 1: //Crear Registro
        ...
        try {
          const { data } = await ClienteHttp.post(
            endPoint.baseURL + endPoint.modImport + endPoint.puerto,
            json
          );
      ...
      case 2: //Modificar || Leer Registro
        ...
        try {
          const { data } = await ClienteHttp.get(
            endPoint.baseURL + endPoint.modImport + endPoint.puerto + `/${id}`
          );
